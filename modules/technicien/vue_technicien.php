        ...
        <div class="row">
            <aside class="card col-lg-7 p-1 m-2">
                ...
                <div class="col-lg card-body">
                    ...
                    <div class="col-lg card-body">
                        <form method="post" action="/technicien/chat/<?= $ticket['idTicket'] ?>/changer-etat" class="input-group">
                ...
                <div class="col-lg card-footer">
                    <a class="btn lire-plus-r" href="/technicien/ticket/<?= $ticket['idTicket'] ?>">Chat</a>
                </div>
            </aside>
