            ...
            <article class="actu card text-center">
                <div class="card-body">
                    ...
                    <p class="card-text">"Le Café pédagogique présente une étude de Jean Heutte publiée dans la révue
                        ...
                        de la démarche expérimentale ) est l’une des rares concernant l’impact de ces technologies
                        sur les résultats des élèves...</p>
                    <a href="/article1" class="btn btn-primary">Voir l'article</a>
                </div>
                <div class="card-footer">20 Janvier 2021</div>
            </article>
            <article class="actu card text-center">
                <div class="card-body">
                    <h2 class="card-title">L’activité sportive : essentielle pour améliorer la concentration</h5>
                        ...
                        <a href="/article2" class="btn btn-primary">Voir l'article</a>
                </div>
                <div class="card-footer">11 Janvier 2021</div>
            </article>
            <article class="actu card text-center">
                <div class="card-body">
                    ...
                    <a href="/article3" class="btn btn-primary">Voir l'article</a>
                </div>
                <div class="card-footer">03 Janvier 2021</div>
            </article>
        </div>
